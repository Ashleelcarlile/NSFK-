            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center w-full sm:max-w-none mx-auto mt-0 sm:mt-0">
              {primaryCTA && (
                <button
                  ...
                  className="relative flex items-center bg-black text-white pl-6 sm:pl-8 pr-16 sm:pr-16 py-3 sm:py-4 rounded-full text-base sm:text-lg font-semibold overflow-hidden group max-w-[260px] sm:max-w-none mx-auto sm:mx-0 w-full sm:w-auto"
              ...
              {secondaryCTA && (
                <button
                  ...
                  className="relative flex items-center bg-transparent border-2 border-black text-black pl-6 sm:pl-8 pr-16 sm:pr-16 py-3 sm:py-4 rounded-full text-base sm:text-lg font-semibold overflow-hidden group max-w-[260px] sm:max-w-none mx-auto sm:mx-0 w-full sm:w-auto"
